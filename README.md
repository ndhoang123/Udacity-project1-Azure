...
2. Create the Policy Assignment
...
3. List the policy assignments to verify
...
1. Fill out those variables on server.json that you got the value above:
...
In order to work easilly on the other machine, you need to open and edit variable on the vars.tf file based on your requirement.